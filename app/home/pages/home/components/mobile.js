        ...
        <React.Fragment>
          <div className='mobile-top'>
            ...
            <div className='mobile-top-wrapper'>
                <p className='mobile-top-title'>React Bricks Web</p>
                <p className='mobile-top-desc'>专注PC Web 端组件封装,用于构建专业的企业中后台管理应用,是我们多年企业开发经验以及集各大家之所长之所得,让开发者更好的开发体验或从其中得到一些启示</p>
            </div>
          </div>
        </React.Fragment>
    );
